...
MPH is designed to partition SNP heritability with genotypes of relates samples or with strong long-span LDs. For such data, LDSC, HE, or MQS do not work well.
