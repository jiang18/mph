...
```
In the *i*th row of the GRM list file are GRM(i) and VC(i). MPH simulates total genetic values (**g**) by sampling from a multivariate normal distribution with variance of GRM(1)\*VC(1)+GRM(2)\*VC(2)+...
