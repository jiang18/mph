...
## Input files
- \-\-grm_list: a space-delimited text file without header. The first column lists the filename prefix of GRMs. The second column is optional and can list a label or an initial VC value for each GRM. 
